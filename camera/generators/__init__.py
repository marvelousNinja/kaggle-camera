...
def sequential_crop(image, size, limit):
    ...
    return sorted_patches[sorted_scores >= 0.5][:limit]
...
def image_generator(labels_and_image_paths, crop_generator=random_crop, crop_size=512, crop_limit=15, seed=11):
    transforms = {
